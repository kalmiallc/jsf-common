...
export function isPropDynamicArray(prop: JsfProp): prop is JsfPropArray { return prop.type === 'array' && !Array.isArray((prop as JsfPropArray).items); }

export function isPropFixedArray(prop: JsfProp): prop is JsfPropArray { return prop.type === 'array' && Array.isArray((prop as JsfPropArray).items); }
