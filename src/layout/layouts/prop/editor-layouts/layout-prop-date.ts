...
export const layoutPropDateJsfDefinition = {
  schema: {
    type      : 'object',
    properties: {
  ...
  layout: {
    ...
    items: [
      ...EditorInterfaceLayoutFactory.createPanelGroup([
        ...EditorInterfaceLayoutFactory.createPanel('Form Control', [
          {
            type: 'div',
            items: [
...
JsfRegister.layout('@prop/date', null, layoutPropDateJsfDefinition);
