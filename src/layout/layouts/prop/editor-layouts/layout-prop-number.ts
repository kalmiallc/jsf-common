...
export const layoutPropNumberJsfDefinition = {
  schema: {
    type      : 'object',
    properties: {
  ...
  layout: {
    ...
    items: [
      ...EditorInterfaceLayoutFactory.createPanelGroup([
        ...EditorInterfaceLayoutFactory.createPanel('Form Control: Number', [
          {
            type: 'div',
            items: [
...
JsfRegister.layout('@prop/number', null, layoutPropNumberJsfDefinition);
