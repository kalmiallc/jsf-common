...
export const layoutPropStringJsfDefinition = {
  schema: {
    type      : 'object',
    properties: {
  ...
  layout: {
    ...
    items: [
      ...EditorInterfaceLayoutFactory.createPanelGroup([
        ...EditorInterfaceLayoutFactory.createPanel('Form Control: String', [
          {
            type: 'div',
            items: [
...
JsfRegister.layout('@prop/string', null, layoutPropStringJsfDefinition);
